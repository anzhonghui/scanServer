...
public class SaveMail {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //    真正要发送时, 邮箱必须是真实有效的邮箱。
        message.setFrom(new InternetAddress("aa@qq.com", "USER_AA", "UTF-8"));

        // 3. To: 收件人
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress("1719120364@qq.com", "`zawsze in love ✘", "UTF-8"));
        //    To: 增加收件人（可选）
