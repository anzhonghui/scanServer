...
public class SendAttachment {
    ...
    public static String myEmailAccount = "15553201090@163.com";
    public static String myEmailPassword = "1719120364an";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1719120364@qq.com";
...
//        text_image.setContent(mm_text_image);
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("excel/NoSendId.xls"));  // 读取本地文件
